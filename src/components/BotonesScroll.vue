<template>
	...
	<div>
		...
		<el-button id="btn_arriba" style="position:fixed; right:20px; width:40px; height:40px; top:20px;" type="primary" plain circle>
			<el-icon><ArrowUpBold /></el-icon>
   		</el-button>

		<el-button id="btn_abajo" style="position:fixed; right:20px; width:40px; height:40px; bottom:20px;" type="primary" plain circle>
